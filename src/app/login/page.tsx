    ...
    <div className="min-h-[80vh] flex items-center justify-center px-4">
      <div className="w-full max-w-sm bg-card border border-border rounded-xl shadow-sm p-8 space-y-6">
        <div className="text-center space-y-2">
          ...
          <p className="text-sm text-muted-foreground">Sign in with your StudentVUE credentials</p>
        </div>
        ...
        <p className="text-xs text-muted-foreground text-center">
          Uses your real MCPS StudentVUE credentials. Your password is never stored.
        </p>
      </div>
    </div>
  )
